...
<img title="latex" style="float: center" alt="No Found" src="/assets/img/LaTex.png" height="60" width="65">
<img title="textstudio" style="float: center" alt="No Found" src="/assets/img/texstudio.png" height="60" width="65">
<img title="pyhton" style="float: center" alt="No Found" src="/assets/img/python.png" height="60" width="65">
...
```
Ahora orientamos el flujo dle programa mediante un if / else:
